...
herbs_all_records = db_session.query(Herb_occurrence, Herb_species).join(Herb_species, Herb_occurrence.scientific_name_id == Herb_species.id).filter(Herb_species.genus == "Acroptilon")
...
if __name__ == '__main__':
    ...
    my_map.save('index_choro2_Acr_spp.html')
